...
class ParalaxImage extends StatefulWidget {
  const ParalaxImage({super.key, required this.image, this.scrollable});

  final ImageProvider image;
  final ScrollableState? scrollable;

  @override
  State<ParalaxImage> createState() => _ParalaxImageState();
}

class _ParalaxImageState extends State<ParalaxImage> {
  final GlobalKey _backgroundImageKey = GlobalKey();

  @override
  Widget build(BuildContext context) {
    final scrollable = widget.scrollable ?? Scrollable.of(context);
    assert(
      scrollable != null,
      'ParalaxImage- Scrollable must not be null, Either pass a scrollable or have a scrollable widget above',
    );
    return Flow(
      ...
      children: [
        Image(image: widget.image, key: _backgroundImageKey, fit: BoxFit.cover),
      ],
    );
  }
}
